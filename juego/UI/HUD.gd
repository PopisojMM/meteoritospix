...
onready var info_laser:ContenedorInformacionEnergia = $EnergiaLaser
onready var info_escudo:ContenedorInformacionEnergia = $EnergiaEscudo
...
func _on_nave_destruida(nave: NaveBase, _posicion) -> void:
	if nave is Player:
